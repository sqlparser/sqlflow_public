...
If it's a public library, you just need to set the URL, you don't need to set the username, password, and sshkeyPath, but if it's a private library, you need to set the username, password, or sshkeyPath and fill in one of them.

Sample configuration of the GitHub or BitBucket public library servers :
````json
"githubRepo":{
...
Sample configuration of the GitHub or BitBucket private library servers:
````json
"githubRepo":{
