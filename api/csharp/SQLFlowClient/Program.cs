...
namespace SQLFlowClient
{
    public class Options
    {
        ...
        [Option('u', "userId", Required = false, Default = "", HelpText = "If userId and secretKey is given, token will be ignore, otherwise it will use token.")]
        public string UserId { get; set; }

        [Option('k', "secretKey", Required = false, Default = "", HelpText = "If userId and secretKey is given, token will be ignore, otherwise it will use token.")]
